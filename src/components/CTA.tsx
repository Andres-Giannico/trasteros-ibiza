      ...
      <Container>
        <div className="relative isolate overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-6 py-24 text-center shadow-2xl rounded-2xl sm:px-16">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Button href="#precios" className="bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 shadow-lg hover:shadow-xl text-white border-0">
              {t.cta.ctaPrimary}
            </Button>
