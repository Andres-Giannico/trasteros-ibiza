      ...
      <Container>
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6">
          {bullets.map((b, i) => (
            <div 
              key={b.title} 
              className={`will-animate group rounded-2xl border border-gray-200 p-6 bg-white shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 hover:border-orange-300 relative overflow-hidden ${
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                ...
                <div className="absolute bottom-6 left-6 w-1 h-1 bg-orange-300 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                <div className="absolute top-1/2 right-2 w-1.5 h-1.5 bg-orange-500 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
              </div>
              
              <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 text-white flex items-center justify-center shadow-lg group-hover:shadow-orange-500/30 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 relative z-10">
